    ...
    >
      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="flex gap-2 mb-[-1px] px-2 relative z-10">
          ...
          >
            <span aria-hidden="true">▶</span> プレイ
          </button>
        </div>
    ...
    <div>
      <form onSubmit={onSubmit} className="mb-8">
        ...
        <div className="flex gap-2 mb-4">
          ...
          >
            <span aria-hidden="true">○</span> 単一選択(正解1つ)
          </button>
          <button
            type="button"
          ...
          >
            <span aria-hidden="true">☑</span> 複数選択(正解複数可)
          </button>
        </div>
        ...
        >
          <span aria-hidden="true">＋</span> 選択肢を追加
        </button>
        ...
        <div className="flex gap-2">
          ...
          >
            {editingId ? <span aria-hidden="true">✓</span> : <span aria-hidden="true">＋</span>}
          ...
          {editingId && (
            ...
            >
              <span aria-hidden="true">✕</span> キャンセル
            </button>
          )}
        </div>
      </form>
    ...
    return (
      <div className="text-center py-10">
        ...
        <button
          ...
          style={{ backgroundColor: INK, color: CARD }}
        >
          <span aria-hidden="true">＋</span> カードを作る
        </button>
      </div>
    );
  }
    ...
    return (
      <div className="text-center py-10">
        <button
          ...
          style={{ backgroundColor: INK, color: CARD }}
        >
          <span aria-hidden="true">▶</span> クイズを始める ({questions.length}問)
        </button>
      </div>
    );
  }
    ...
    return (
      <div className="text-center py-6">
        ...
        <button
          ...
          style={{ backgroundColor: INK, color: CARD }}
        >
          <span aria-hidden="true">↺</span> もう一度
        </button>
      </div>
    );
  }
    ...
    <div>
      ...
      {isMultiple && (
        <p className="body-font text-xs mb-4 flex items-center gap-1" style={{ color: INK_SOFT }}>
          <span aria-hidden="true">☑</span> 当てはまるものをすべて選んでください
        </p>
      )}
      ...
      {isMultiple && !answered && (
        <button
          ...
          style={{ backgroundColor: INK, color: CARD }}
        >
          <span aria-hidden="true">✓</span> 解答する
        </button>
      )}
      ...
      {answered && (
        <button
          ...
          style={{ backgroundColor: INK, color: CARD }}
        >
          {idx + 1 >= order.length ? "結果を見る" : "次のカード"} <span aria-hidden="true">›</span>
        </button>
      )}
    </div>
  );
